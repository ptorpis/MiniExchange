...
| **ORDER_ACK**              | 11 / `0x0B`    | server - client | 80       | Server Client ID `uint64_t` <br> Instrument ID `uint32_t` <br>Server Order ID `uint64_t` <br> Status `uint8_t` <br> Reject Flag `uint8_t` <br> Accepted Price `int64_t` <br> Server Time `uint64_t` <br> Latency `uint32_t` <br> Padding `uint8_t[6]`<br> HMAC `uint8_t[32]`| 96           |
...
| **MODIFY_ORDER**           | 14 / `0x0E`    | client - server | 64       | Server Client ID `uint64_t` <br>Server Order ID: `uint64_t` <br> New Quantity: `int64_t` <br> Padding: `uint8_t[8]` <br> HMAC: `uint8_t[32]`                                                    | 80           |
| **MODIFY_ACK**             | 15 / `0x0F`    | server - client | 64       | Server Client ID `uint64_t` <br> Server Order ID: `uint64_t` <br> Status: `uint8_t` <br> Latency `uint32_t`<br>Padding: `uint8_t[11]` <br> HMAC: `uint8_t[32]`                             | 64           |
